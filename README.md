...
The product navigation stays at the top once scrolled past. A compact, theme-matched logo fades in on its left and replays the same animation on mouse hover or activation. Activating it jumps immediately to the top and replays the main logo there; keyboard focus follows the main logo. The compact logo is removed from the tab order while hidden, section anchors clear the sticky bar, and reduced motion preserves static logos.
